...
export interface BannerSlide {
  ...
  title: string
  sub: string
  /** URL-safe identifier used for per-banner routes */
  slug: string
  /** Zero-based position in the BANNER_SLIDES array */
  index: number
}
...
/** Lookup a slide by its URL slug. */
export const BANNER_BY_SLUG: Record<string, BannerSlide> =
  Object.fromEntries(BANNER_SLIDES.map((s) => [s.slug, s]))

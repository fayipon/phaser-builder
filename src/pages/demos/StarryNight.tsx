...
export default function StarryNight() {
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-[#0a0e2a]">
      ...
      <div className="absolute inset-x-0 bottom-0 z-20 pointer-events-none">
        <div className="bg-gradient-to-t from-black/60 via-black/30 to-transparent px-6 sm:px-10 pb-8 pt-24">
          <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-widest border rounded-full px-2.5 py-0.5 mb-3 bg-purple-500/20 text-purple-300 border-purple-500/30">
            Painterly Canvas
          </span>
          ...
          <p className="text-sm sm:text-base text-white/50 max-w-lg leading-relaxed">
            以 Canvas 2D 繪製梵谷名畫的寫實詮釋。流動筆觸、漩渦光帶與星光暈染均由程序即時運算，非靜態圖片。
          </p>
        </div>
      </div>
    </div>
